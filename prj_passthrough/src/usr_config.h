...
#define CFG_LOCAL_NAME   "Passthrough"
...
#define CFG_MEM_RETENTION   (MEM_ALL)
...
///Qpp profile service role
#define CFG_PRF_QPPS
#define CFG_TASK_QPPS     TASK_PRF1

///QPP profile client role
//#define CFG_PRF_QPPC
//#define CFG_TASK_QPPC     TASK_PRF1

///OTA profile service role
#define CFG_PRF_OTAS 
#define CFG_TASK_OTAS		TASK_PRF2
