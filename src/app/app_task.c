...
const struct ke_msg_handler app_default_state[] =
{
    ...
    {APP_ADV_STOP_TIMER,                    (ke_msg_func_t) app_adv_stop_timer_handler},

#if (QN_PT_BOTTON)
    {APP_SYS_GPIO_STCHANGE_TIMER,           (ke_msg_func_t) app_pt_gpio_timer_handler},
    {APP_SYS_GPIO_TXWAKEUP_TIMER,           (ke_msg_func_t) app_pt_gpio_timer_handler},
#endif
    ///leo end
#endif
...
///leo add		
#if BLE_QPP_CLIENT
    {QPPC_ENABLE_CFM,                   	(ke_msg_func_t) app_hrpc_enable_cfm_handler},
    {QPPC_ERROR_IND,                    	(ke_msg_func_t) app_hrpc_error_ind_handler},
    {QPPC_RD_CHAR_RSP,                  	(ke_msg_func_t) app_hrpc_rd_char_rsp_handler},
    {QPPC_WR_CHAR_RSP,                  	(ke_msg_func_t) app_hrpc_wr_char_rsp_handler},
    {QPPC_DATA_IND,                  	    (ke_msg_func_t) app_hrpc_meas_ind_handler},
    {QPPC_DISABLE_IND,                      (ke_msg_func_t) app_qppc_disable_ind_handler},
    {APP_QPPS_TIMER,                   	 	(ke_msg_func_t) app_hrpc_timer_handler},
#endif
