...
#define nvds_del ((p_nvds_del)(_nvds_del))
...
#define nvds_lock ((p_nvds_lock)(_nvds_lock))
 ...
 ****************************************************************************************
 */
typedef uint8_t (*p_nvds_put)(uint8_t tag, nvds_tag_len_t length, uint8_t *buf);
#define nvds_put ((p_nvds_put)(_nvds_put))
