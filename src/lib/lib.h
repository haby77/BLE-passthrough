...
typedef void (*uart_api)(QN_UART_TypeDef *UART, uint8_t *bufptr, uint32_t size, void (*rx_callback)(void));
 ...
 * @param[in]   uart            The UART interface which is used in NP or Controller mode
 * @param[in]   uart_read       The UART read API
 * @param[in]   uart_write      The UART write API
 ...
 ****************************************************************************************
 */
extern void ble_init(enum WORK_MODE mode, QN_UART_TypeDef *uart, uart_api uart_read, uart_api uart_write, uint8_t *ble_heap_addr, uint32_t ble_heap_size, bool sleep_enable);
 ...
 ****************************************************************************************
 */
extern void config_work_mode(enum WORK_MODE mode, QN_UART_TypeDef *uart, uart_api uart_read, uart_api uart_write);
