...
{
    ///Status about database creation
    uint8_t status;
};
...
struct tips_time_upd_ctnl_pt_ind
{
    ///Connection handle
    uint16_t conhdl;
    ///Time Update Control Point value written by the peer client
...
extern void task_tips_desc_register(void);
